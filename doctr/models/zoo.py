...
def _predictor(det_arch: str, reco_arch: str, pretrained: bool, det_bs=2, reco_bs=128, assume_straight_pages=True, margin=0) -> OCRPredictor:
    ...
    return OCRPredictor(det_predictor, reco_predictor, assume_straight_pages=assume_straight_pages, margin=margin)
